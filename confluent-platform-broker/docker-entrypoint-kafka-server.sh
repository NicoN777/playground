...
SCHEMA_REGISTRY_PROPERTIES=${SCHEMA_REGISTRY_CONF_DIR}/schema-registry.properties
# Schema Registry Properties
{
  ...
  echo "kafkastore.ssl.client.authentication=${SSL_CLIENT_AUTHENTICATION}"
...
exec kafka-server-start ${SERVER_PROPERTIES}